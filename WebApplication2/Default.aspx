...
<p style="height: 33px">
    ...
    <p style="height: 64px" id="Results">
        ...
        <asp:FormView ID="FormView4" runat="server" CellPadding="4" DataSourceID="SqlDataSource8" ForeColor="#333333">
            <EditItemTemplate>
                Over10g:
                <asp:TextBox ID="Over10gTextBox" runat="server" Text='<%# Bind("Over10g") %>' />
                <br />
        ...
        <asp:FormView ID="FormView5" runat="server" DataSourceID="SqlDataSource9">
            <EditItemTemplate>
                Over80g:
                <asp:TextBox ID="Over80gTextBox" runat="server" Text='<%# Bind("Over80g") %>' />
                <br />
